...
<table border="1">
    <tr>
        ...
        <td><p>Gêneros textuais acadêmicos.</p><p><a href="https://github.com/eejamtecnico/MetodologiaDoTrabalhoCientifico2/blob/main/mtc2a.pdf">Atividade 1</a></p><p><a href="https://github.com/eejamtecnico/MetodologiaDoTrabalhoCientifico2/blob/main/mtc2b.pdf">Atividade 2</a></p></td>
    </tr>
    <tr>
        <td></td>
        <td>Leitura de textos científicos: skimming e scanning.</td>
    </tr>
    <tr>
        <td></td>
        <td>ABNT: Fichamento, referências e citações.</td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td>Buscando fontes confiáveis e atualizando o estado da arte.</td>
    </tr>    
</table>
...
<table border="1">
    ...
    <tr>
        <td></td>
        <td>instrumentos de coleta de dados: entrevista, formulários (impressos ou digitais), bases de dados científicas e governamentais.</td>
    </tr>
</table>
...
<table border="1">
    ...
    <tr>
        <td></td>
        <td>Análise de similaridade para dados qualitativos usando o IRAMUTEC.</td>
    </tr>
    <tr>
        <td></td>
